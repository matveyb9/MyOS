...
static void command_help(const char *topic) {
    ...
    if (text_equal(topic, "asm")) {
        ...
        write_text("Source: input; time; args; set <0..255>; not; neg; inc; dec; add/sub/mul/and/or/xor <0..255>; shl/shr/rol/ror <1..7>; div/mod <1..255>; store/load/cmp <0..7>; label name:; write \"text\"; jump[_if_zero|_if_nonzero] name; jump_if <0..255> name; exit <0..255>\n");
