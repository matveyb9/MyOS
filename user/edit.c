...
void _start(uint64_t argc, const char *arguments) {
    ...
    if (system_call(MYOS_SYS_TMPFS_WRITE, 0U, (uint64_t)(uintptr_t)&write_request, sizeof(write_request)) == UINT64_MAX) {
