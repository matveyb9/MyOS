...
$(INITRAMFS): $(USER_INIT) $(USER_HELLO) $(USER_SLEEPER) $(USER_ORPHANER) $(USER_SAFETY) $(USER_ARGSHOW) $(USER_CALC) $(USER_PIPEWRITE) $(USER_PIPEREAD) $(USER_WC) $(USER_GREP) $(USER_EDIT) $(USER_STARTGUI) $(USER_INSTALL) $(USER_ASM) $(USER_TREE) $(USER_FIND) $(USER_STACKPROBE) $(USER_HEAD) $(USER_STAT) $(SDK_HELLO) $(SDK_CP) $(USER_MOTD) user/gui_4k_fixture.txt tools/mkcpio.py Makefile
	python3 tools/mkcpio.py $@ system/core/apps/init.elf $(USER_INIT) system/core/apps/hello.elf $(USER_HELLO) system/core/apps/sleeper.elf $(USER_SLEEPER) system/core/apps/orphaner.elf $(USER_ORPHANER) system/core/apps/safety.elf $(USER_SAFETY) system/core/apps/argshow.elf $(USER_ARGSHOW) system/core/apps/calc.elf $(USER_CALC) system/core/apps/pipewrite.elf $(USER_PIPEWRITE) system/core/apps/piperead.elf $(USER_PIPEREAD) system/core/apps/wc.elf $(USER_WC) system/core/apps/grep.elf $(USER_GREP) system/core/apps/edit.elf $(USER_EDIT) system/core/apps/startgui.elf $(USER_STARTGUI) system/core/apps/install.elf $(USER_INSTALL) system/core/apps/asm.elf $(USER_ASM) system/core/apps/tree.elf $(USER_TREE) system/core/apps/find.elf $(USER_FIND) system/core/apps/stackprobe.elf $(USER_STACKPROBE) system/core/apps/head.elf $(USER_HEAD) system/core/apps/stat.elf $(USER_STAT) system/core/examples/sdk/hello.elf $(SDK_HELLO) system/core/apps/cp.elf $(SDK_CP) system/core/resources/motd.txt $(USER_MOTD) system/core/resources/gui-4k.txt user/gui_4k_fixture.txt
