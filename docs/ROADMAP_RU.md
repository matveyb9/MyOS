...
| `gui/bringup` | Изолированная разработка framebuffer GUI и user-program platform. | `[~]` Preview checkpoint `v0.12.2-gui-preview` и GitHub Pre-release `v0.13.0-gui-rc.1` опубликованы; MYPFS004, persistent ELF execution, внешний SDK и bounded native argument/input/time toolchain реализованы без слияния в `main`. |
