...
The release includes write/read, process lifecycle, task info, VFS read/enumeration/create/write/remove/rename, RTC/uptime, bounded spawn arguments, tmpfs/persistent-file operations, pipe operations, reboot and poweroff. The most important limits are:
