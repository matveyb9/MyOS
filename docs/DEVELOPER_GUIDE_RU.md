...
| GUI content request | 4 240 bytes: четыре 64-bit fields, NUL-terminated title 112 bytes и content 4 096 bytes; dedicated active-session mapped-range copy |
