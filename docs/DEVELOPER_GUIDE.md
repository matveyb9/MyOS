...
| GUI content request | 1,072 bytes; dedicated active-session mapped-range copy |
| GUI viewer/editor content | 1 KiB (1,024 bytes); at most four 256-byte VFS transfers |
