...
> **Текущая линия разработки:** `feature/gui`, версия `0.12.2-dev`. Стабильная консольная граница сохранена immutable тегом `v0.12.1-console`; GUI и MYPFS004 пока не переносятся в эту границу автоматически.
