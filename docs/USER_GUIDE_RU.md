...
| `startgui` | `startgui` | Запустить experimental framebuffer GUI. Нажмите `FILES`, чтобы просматривать logical VFS от `/users/myos/`; writable text files до 16 KiB открываются в GUI editor. |
