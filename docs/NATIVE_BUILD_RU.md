...
| Executable statements | Не более 64 суммарных `write`, `args`, `input`, `time`, `set`, `not`, `and`, `or`, `xor`, `shl`, `shr`, `add`, `sub`, `mul`, `div`, `store`, `load`, `cmp`, jump и `exit` instructions. |
