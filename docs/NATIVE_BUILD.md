...
| Executable statements | At most 64 total `write`, `args`, `input`, `time`, `set`, `not`, `and`, `or`, `xor`, `shl`, `shr`, `rol`, `ror`, `add`, `sub`, `mul`, `div`, `mod`, `store`, `load`, `cmp`, jump and `exit` instructions. |
