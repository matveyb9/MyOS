...
| Executable statements | At most 64 total `write`, `args`, `input`, `time`, `set`, `not`, `neg`, `inc`, `dec`, `test`, `and`, `or`, `xor`, `shl`, `shr`, `rol`, `ror`, `add`, `sub`, `mul`, `div`, `mod`, `store`, `load`, `cmp`, `swap`, jump and `exit` instructions. |
