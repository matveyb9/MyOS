...
| Desktop home | Bare `startgui` renders the fixed `MYOS DESKTOP` launcher; `startgui home` is a compatibility alias; it does not scan arbitrary paths, create tasks or retain unbounded state. |
