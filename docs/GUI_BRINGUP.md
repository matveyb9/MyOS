...
| File Workspace | `FILES` begins at `/users/myos/`, supports parent and paged directory navigation across the complete logical VFS, and identifies directories, regular files and virtual entries. |
