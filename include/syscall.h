...
#define MYOS_SYS_VFS_MOVE UINT64_C(35)
...
#define MYOS_GUI_CONTENT_FLAG_BROWSER UINT64_C(4)
...
#define MYOS_INPUT_GUI_ACTION_APP_BASE UINT8_C(0x8e)
#define MYOS_GUI_LAUNCHER_APP_MAX UINT8_C(4)
#define MYOS_INPUT_GUI_ACTION_FILES UINT8_C(0x92)
#define MYOS_INPUT_GUI_ACTION_BROWSER_PARENT UINT8_C(0x93)
#define MYOS_INPUT_GUI_ACTION_BROWSER_PREVIOUS UINT8_C(0x94)
#define MYOS_INPUT_GUI_ACTION_BROWSER_ENTRY_BASE UINT8_C(0x95)
#define MYOS_GUI_BROWSER_ENTRY_MAX UINT8_C(4)
#define MYOS_INPUT_GUI_ACTION_BROWSER_NEXT UINT8_C(0x99)
#define MYOS_INPUT_GUI_ACTION_BROWSER_CREATE UINT8_C(0x9a)
#define MYOS_INPUT_GUI_ACTION_BROWSER_CREATE_DIRECTORY UINT8_C(0x9b)
...
#define MYOS_INPUT_GUI_ACTION_BROWSER_MOVE UINT8_C(0xa0)
...
#define MYOS_GUI_CONTENT_TITLE_MAX MYOS_VFS_PATH_MAX
#define MYOS_GUI_CONTENT_MAX UINT64_C(16384)
#if (MYOS_GUI_CONTENT_MAX % MYOS_VFS_READ_CHUNK) != 0
#error "MYOS_GUI_CONTENT_MAX must be a whole number of VFS chunks"
#endif
